...
public class Phimdangchieu extends Activity {
    ListView lvPhim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phimdangchieu);

        lvPhim = (ListView) findViewById(R.id.lvdangchieu);

        if (AllConfig.JSONPhimdangchieu==null) {
            new LoadJson().execute(AllConfig.IP_ADDRESS + "/phimdangchieu/phim_dang_chieu.php");
        }
        else {
            try {
               PrintListview(AllConfig.JSONPhimdangchieu);
    ...
    protected void PrintListview(JSONArray json) throws JSONException {
        ...
        lvPhim.setAdapter(new LVphimdangchieuAdapter(Phimdangchieu.this,listMockData));
        lvPhim.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                Intent chuyen = new Intent(Phimdangchieu.this,PhimdangchieuNoidung.class);
    ...
    private class LoadJson extends AsyncTask<String, Integer,String>
    {
        ...
        protected void onPostExecute(String s) {
            try {
                JSONArray json = AllConfig.JSONPhimdangchieu = new JSONArray(s);
                PrintListview(json);
