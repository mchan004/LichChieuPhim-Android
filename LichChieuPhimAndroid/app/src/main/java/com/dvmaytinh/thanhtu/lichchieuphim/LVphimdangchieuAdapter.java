...
/**
 * Created by spqtt on 10/21/2016.
 */

public class LVphimdangchieuAdapter extends BaseAdapter{

    private ArrayList<ItemPhimdangchieu> dsphim;
    private LayoutInflater layoutInflater;

    public LVphimdangchieuAdapter(Context context, ArrayList<ItemPhimdangchieu> dsphim) {
        this.dsphim = dsphim;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.rowdangchieu, null);
